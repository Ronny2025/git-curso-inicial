...
public class Practice_12_17 {
    ...
    public static void main(String[] args) {
        //             01234567890
      /*  String casa = "yo amo java";

        System.out.println(casa.substring(0,2));

        System.out.println(casa.substring(3));
        //System.out.println(casa.());
        System.out.println(casa.toUpperCase());
        System.out.println(casa.substring(3,11));
        System.out.println(casa.toLowerCase());
        System.out.println(casa.length());
        System.out.println(casa.charAt(9));
        for (int i = 0; i < casa.length(); i++) {
            System.out.print(casa.charAt(i));
            //String method
/*
