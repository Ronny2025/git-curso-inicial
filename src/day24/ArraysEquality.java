...
public class ArraysEquality {
    ...
    public static void main(String[] args) {
        ...
        int[] scores4={6,5,6,7,3,2,3,34}; //it has same numbers as 3 but different order

        System.out.println(scores1== scores2);
        System.out.println(scores1== scores3);

        //for checking for equality of 2 array object content
        //equals ==. Arrays.equals(firstArray,secondaryArray)
        ...
        System.out.println(" is score1 has same content as score4 =" + isS3S4Equals);
